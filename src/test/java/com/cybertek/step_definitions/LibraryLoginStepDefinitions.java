...
public class LibraryLoginStepDefinitions {
    ...
    public void user_logs_in_as_librarian(){
        System.out.println("user_logs_in_as_librarian");
    }

    @Then("User should see dashboard")
    public void user_should_see_dashboard(){
        System.out.println("user_should_see_dashboard");
    }

    @When("User logs in as student")
    public void user_logs_in_as_student() {
        System.out.println("user_logs_in_as_student");
    }

    @When("User logs in as admin")
    public void user_logs_in_as_admin() {
        System.out.println("user_logs_in_as_admin");   }
